...
def add_holding(request):
    ...
    if request.method == "POST":
        ...
        if crypto_name and amount and avg_price:
            ...
            messages.success(
                request, f"Holding for {crypto_name} added successfully.")
...
def edit_holding(request, holding_id):
    ...
    if request.method == "POST":
        ...
        holding.save()
        messages.success(
            request, f"Holding for {holding.cryptocurrency.name} updated successfully.")
        return redirect('home')
...
def delete_holding(request, holding_id):
    ...
    holding.delete()
    messages.success(
        request, f"Holding for {holding.cryptocurrency.name} deleted successfully.")
    return redirect('home')
